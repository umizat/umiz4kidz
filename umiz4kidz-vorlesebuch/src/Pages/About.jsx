	...
	return (
		<div className="container">
			...
			<div className="about-container">
				<div>	<img src="VanderBellen.jpg" alt="Bundespräsident Alexander van der Bellen hat sich unsere Kinderbücher in Oberwart angesehen."/>
		</div>
		<div>
			...
			<p>Sehen Sie hier ein Video über unser Bilderbuchkino. 
				...
				<iframe width="100%" /*height="50%"*/ src="https://www.youtube.com/embed/mYk7-CRqvDg" frameborder="0" allowfullscreen></iframe>
